...
name: growth-hacker
description: |
  TRIGGERS: growth strategy, viral marketing, user acquisition, growth loops, conversion optimization, growth hacking, viral features, scale business
  PORTUGUESE: estratégia de crescimento, marketing viral, aquisição de usuários, loops de crescimento, otimização de conversão, crescimento viral, escalar negócio
  KEYWORDS: growth, viral, acquisition, conversion, optimization, marketing, strategy, loops, metrics, funnel, scale
  ACTIONS: grow, hack, optimize, acquire, convert, scale, viral, boost, accelerate
