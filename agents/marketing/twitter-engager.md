...
description: |
  TRIGGERS: Twitter strategy, tweet creation, Twitter engagement, viral tweets, Twitter threads, social engagement, Twitter growth, X platform
  PORTUGUESE: estratégia Twitter, criar tweets, engajamento Twitter, tweets virais, threads Twitter, engajamento social, crescimento Twitter, plataforma X
  KEYWORDS: Twitter, tweet, engagement, viral, thread, hashtag, retweet, trending, social, X
  ACTIONS: tweet, engage, thread, viral, trend, reply, retweet, grow, amplify
